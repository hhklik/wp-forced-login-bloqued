...
function kt_login_init() {
   	...
   	if(isset($_POST['kttl'])){
		...
		if(!($_POST['kttl'] == $_SESSION["kt_token_login"])){
			echo 'Spanish: ve y busca un codigo para niños <a href="wp-login">click para Regresa a login<a/> <br> English: go and look for a children\'s code <a href="wp-login">click Go back login<a/>';
			exit;
		}
